    ...
    public partial class COD : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack==false)
            {
                ...
                {
                    Label1.Text = "Transaction successful!"+"<br/>"+"Payment of PKR" + Session["total"] + " received." + "<br/><br/>" + "Please provide Delivery details.";
                }
                else if(Session["pay"].ToString()=="COD")
                {
                    Label1.Text = "Please provide Delivery details.";
                }
                string constr = @"Data Source=NAMRARATHORE\MSSQLSERVER01;Initial Catalog=CFOS;Integrated Security=True";
